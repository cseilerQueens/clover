...
#' @description This function accesses the values and metadata of a given variable
#'
...
#'
#' @return A list with the values and metadata of a given variable
#'
#' @export
#'

clover.values <- function(dataDir, ncFileName, variableName) {
